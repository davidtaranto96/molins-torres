#!/bin/sh
# Versiona el CSS y el JS de la portada para que el navegador no sirva uno viejo
# con un HTML nuevo (pasó el 3/9: la sección oscura salía crema y sin recortes).
